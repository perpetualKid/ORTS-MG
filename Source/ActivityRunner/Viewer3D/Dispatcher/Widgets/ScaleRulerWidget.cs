...
{
    internal class ScaleRulerWidget : PointWidget
    {
        ...
        internal override void Draw(Graphics g)
        {
            ...
            g.DrawLine(rulerPen, Location.X, windowSize.Height - Location.Y, Location.X + rulerLength, windowSize.Height - Location.Y);
            g.DrawLine(rulerPen, Location.X, windowSize.Height - Location.Y + markerLength, Location.X, windowSize.Height - Location.Y - markerLength);
            g.DrawLine(rulerPen, Location.X + rulerLength, windowSize.Height - Location.Y + markerLength, Location.X + rulerLength, windowSize.Height - Location.Y - markerLength);
            g.DrawLine(rulerPen, Location.X + rulerLength * 0.5f, windowSize.Height - Location.Y + markerLength, Location.X + rulerLength * 0.5f, windowSize.Height - Location.Y - markerLength);
            //g.DrawLine(rulerPen, Location.X + rulerLength * 0.25f, dimensions.Height - Location.Y - markerLength, Location.X + rulerLength * 0.25f, dimensions.Height - Location.Y);
            //g.DrawLine(rulerPen, Location.X + rulerLength * 0.75f, dimensions.Height - Location.Y - markerLength, Location.X + rulerLength * 0.75f, dimensions.Height - Location.Y);

            if (content.MetricUnits)
            {
                SizeF textSize = g.MeasureString(MetricRuler.m0_0.GetDescription(), markerFont);
                g.DrawString(MetricRuler.m0_0.GetDescription(), markerFont, new SolidBrush(Color.Black), Location.X - textSize.Width / 2, windowSize.Height - Location.Y + 5);
                textSize = g.MeasureString(metricRuler.GetDescription(), markerFont);
                g.DrawString(metricRuler.GetDescription(), markerFont, new SolidBrush(Color.Black), Location.X + rulerLength - textSize.Width / 2, windowSize.Height - Location.Y + 5);
            }
            else
            {
                SizeF textSize = g.MeasureString(ImperialRuler.i0_0.GetDescription(), markerFont);
                g.DrawString(ImperialRuler.i0_0.GetDescription(), markerFont, new SolidBrush(Color.Black), Location.X - textSize.Width / 2, windowSize.Height - Location.Y + 5);
                textSize = g.MeasureString(imperialRuler.GetDescription(), markerFont);
                g.DrawString(imperialRuler.GetDescription(), markerFont, new SolidBrush(Color.Black), Location.X + rulerLength - textSize.Width / 2, windowSize.Height - Location.Y + 5);
            }
        }
    }
}
